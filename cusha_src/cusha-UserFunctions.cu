...
void completeEntryCuSha (	unsigned int argcount,	// The number of additional items in the line
...
__device__ void init_compute_CuSha(	Vertex* local_V,	// Address of the corresponding vertex in shared memory.
...
__device__ bool update_condition_CuSha(	Vertex* local_V,	// newly calculated vertex content.
